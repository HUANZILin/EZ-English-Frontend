...
const DUMMY_Messenge = [
    {
        ID: "A01",
        Speaker : "AI",
        Messenge : "歡迎進入AI對話學習，我是你的學習小助手！Welcome here, I am your AI learning Helper!"
    },
    {
        ID: "A02",
        Speaker : "AI",
        Messenge : "請隨意輸入您想跟我聊的內容，我會及時糾正您的文法並回覆！Feel free to input any content you'd like to chat with me about. I'll promptly correct your grammar and provide a response!"
    },
    {
        ID: "B01",
        Speaker : "User",
...
const AICommunication = () => {
    ...
    return(
        ...
        {MessengesData.map((context) => (
            <Messenges key={context.ID} text={context.Messenge} speak={context.Speaker}/>))}
        </ChatBlock>
